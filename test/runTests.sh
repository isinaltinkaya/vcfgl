...
ID="test1"
INFILENAME="t1.vcf"
ARGS="-O v --seed 42 -d 1 -e 0.01 --pos0 0 -explode 0"
...
ID="test2"
INFILENAME="t1.vcf"
ARGS="-O v --seed 42 -d 1 -e 0.01 --pos0 0 -explode 1"
...
ID="test3"
INFILENAME="t1.vcf"
ARGS="-O v --seed 42 -d 1 -e 0.01 --pos0 1 -explode 0"
...
ID="test4"
INFILENAME="t1.vcf"
ARGS="-O v --seed 42 -d 1 -e 0.01 --pos0 1 -explode 1"
...
ID="test7"
INFILENAME="t2.vcf"
ARGS="-O v --seed 42 -d 1 -e 0.01 --pos0 1 -explode 1 -addGP 1 -addPL 1"
...
# # ID="test8"
# # INFILENAME="t2.vcf"
# # ARGS="-O v --seed 42 -d 1 -e 0.01 --pos0 1 -explode 1 -addQS 1 -addGP 1 -addPL 1 --trim-alt-alleles 1"
...
ID="test9"
INFILENAME="t2.vcf"
ARGS="-O v --seed 42 -d 1 -e 0.01 --pos0 1 -explode 1 -addQS 0 -addGP 1 -addPL 1"
